...
PCC3H	= defs.h types.h bucket.h symtab.h $(BACKEND).h tree.h encode.h

PCC3OBJ = main.o message.o symtab.o types.o bucket.o utils.o gram.o scan.o $(BACKEND).o tree.o encode.o
